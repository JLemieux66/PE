"""
Enrich Vista Equity Partners data with Crunchbase and Swarm APIs
"""
import json
import time
...
def main():
    ...
    # Load existing Vista data
    print("📂 Loading vista_portfolio_with_status.json...")
    with open("vista_portfolio_with_status.json", "r", encoding="utf-8") as f:
        data = json.load(f)
    ...
    for idx, company in enumerate(companies, 1):
        ...
        # Step 1: Crunchbase for HQ and founding year
        ...
        if swarm_ids:
            ...
            if swarm_details:
                ...
                hq = company.get("headquarters", "N/A")[:30]
    ...
    output_file = "vista_portfolio_full_enriched.json"
